...
export const NODE_DEFS = [
  ...
  { kind: 'imageGen', cat: 'generation', icon: '◇', name: 'Image Gen', desc: 'Web task: tạo ảnh trên tool AI (Pick Click)',
    schema: [
      ...
      { key: 'url',            label: 'Tool URL',         type: 'text',   default: '' },
      { key: 'steps',          label: 'Steps (JSON)',     type: 'json',   default: [] },
      { key: 'sessionId',      label: 'Session ID',       type: 'text',   default: '' },
      { key: 'delay',          label: 'Delay ms/step',    type: 'number', default: 300 },
      { key: 'grabFrom',       label: 'Grab output from', type: 'text',   default: '' },
      { key: 'grabAttr',       label: 'Grab attribute',   type: 'select', options: ['src','href','text'], default: 'src' },
      { key: 'waitFor',        label: 'Wait stable selector', type: 'text', default: '' },
      { key: 'timeout',        label: 'Timeout (sec)',    type: 'number', default: 180 },
    ]},
  { kind: 'videoGen', cat: 'generation', icon: '▷', name: 'Video Gen', desc: 'Web task: tạo video trên tool AI (Pick Click)',
    schema: [
